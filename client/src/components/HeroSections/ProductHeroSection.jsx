...
export const HeroSection = ({ 
  ...
  title = {
    line1: { white: "High-Performance ", orange: "Batteries" },
    line2: { white: "for Industrial ", orange: "Power" }
  },
  description = "Discover our premium selection of lithium traction, solar, deep cycle, and lead-acid battery systems engineered for critical infrastructure and logistics.",
  ...
  const handlePrimaryClick = () => {
    // Scroll down to the products list section
    const productsSection = document.getElementById("products-catalog-section");
    if (productsSection) {
