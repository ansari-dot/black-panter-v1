...
export const HeroSection = ({ 
  ...
  title = {
    line1: { white: "Powering ", orange: "Industries" },
    line2: { white: "with Expert ", orange: "Solutions" }
  },
  description = "With years of experience in industrial battery services, we are committed to delivering excellence in maintenance, testing, and support for critical power systems.",
  ...
  const handlePrimaryClick = () => {
    // For "Learn More", we'll scroll down or navigate to a specific section
    // For now, let's navigate to services as it's more relevant
    navigate('/services');
  };
